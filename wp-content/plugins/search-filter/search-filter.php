	...
	class SearchAndFilter
	{
		...
		function filter_query_post_types($query)
		{
			...
			if(($query->is_main_query())&&(!is_admin()))
			{
				...
				//$query->query_vars[‘Other’] = -2;**anusha
		...
		/*function my_modify_main_query( $query ) {
			...
			$query->filter_query_post_types[‘Other’] = -2; // exclude this category from the homepage search because it's ony for adverts and not other information
			...
			//add_action( 'posts_selection', array($this,‘my_modify_main_query’ );*/
		...
		*/
		public function set_defaults()
		{
			...
			if(isset($wp_query->query['category_name']))
			{
				...
				$wp_query->query_vars[‘Other’] = -2; // exclude this category from the homepage search because it's ony for adverts and not other information

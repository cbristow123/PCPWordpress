...
= 2.9.2 =
- Resolved the job application & features saving issue in case of new job.

Added new UI & setup wizard.
- Note: [Please update theme templates with SJB 2.9.0] ( https://wordpress.org/support/topic/please-update-theme-templates-with-sjb-2-9-0/)
- By default classical( old UI ) will be enabled. You can change it by selecting the Modern Layout from Settings > Appearance Tab. 
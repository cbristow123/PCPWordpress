...
Tags: excel, spreadsheet, xls, xlsx, embed, import, upload, form, calculator, viewer, chart, graph
...
1. Verify that you are using a Windows PC with a supported version of Excel, as listed in [the requirements on the download page](http://www.spreadsheetconverter.com/download/ "Link to the SpreadsheetConverter download page") . 

jQuery(document).ready(function(){
    ...
    var iframe_width          = jQuery("#iframe_width").val();
		...
		var button_link           = jQuery("#btn_link").val();
...
jQuery('#btn_link').change(function() {
	...
	jQuery.ajax({
      ...
      jQuery('#file_url').val(jQuery.trim(data.html));
      jQuery('#iframe_width').val(data.width);
			jQuery('#iframe_height').val(data.height);
		}
	});
